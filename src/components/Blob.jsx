...
void main() {
  ...
  // Approximate normal from displacement derivative (will be refined in fragment)
...
void main() {
  ...
  // Compute perturbed normal using screen-space derivatives (smooth liquid effect)
  ...
  // Liquid mirror: 100% metallic, roughness 0.05 => crisp reflections
  ...
  return (
    <mesh ref={meshRef} position={[0, 0, 0]}>
      ...
      <shaderMaterial
        ...
        uniforms={uniforms}
        // The shader itself achieves the liquid mirror look – metalness 1, roughness 0.05 equivalent
      />
    </mesh>
  )
}
